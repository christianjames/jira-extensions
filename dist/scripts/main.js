...
var botaoRegistroTrabalho = document.querySelector('.issueaction-log-work');

if (botaoRegistroTrabalho) {
    var setarIntervalTimer = function setarIntervalTimer() {
        var interval = setInterval(function () {
            var tempo = localStorage.getItem('dataHoraLogwork-' + issueKey);

            var duration = _moment2.default.duration((0, _moment2.default)().diff(tempo));
    ...
    document.querySelector('.issueaction-logwork-start').addEventListener('click', function () {
        var dataHoraAgora = (0, _moment2.default)().format();
    ...
    document.querySelector('.issueaction-logwork-stop').addEventListener('click', function () {
        ...
        var tempo = localStorage.getItem('dataHoraLogwork-' + issueKey);
        var diff = (0, _moment2.default)((0, _moment2.default)()).diff(tempo, 'm');
